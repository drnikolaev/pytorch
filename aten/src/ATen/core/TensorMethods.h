...
inline Tensor & Tensor::xput_(const Tensor & index, const Tensor & source, bool accumulate, const Tensor & beforeIndex, const Tensor & afterIndex, int64_t emptyBefore, int64_t emptyAfter) {
    return dispatch_type().xput_(*this, index, source, accumulate, beforeIndex, afterIndex, emptyBefore, emptyAfter);
}
